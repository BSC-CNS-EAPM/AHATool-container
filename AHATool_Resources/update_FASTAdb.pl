#!/usr/bin/perl
# ~~~~~~~This is an abreviated version of update_blastdb.sh~~~~~~~
# Responsible for Changes:  Nele Schulte
# Aim: Having the file do an automatic update of a FASTA db instead of blastdb.
...
use constant BLAST_DB_DIR => "/blast/db/FASTA";
